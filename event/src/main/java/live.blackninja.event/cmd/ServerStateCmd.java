...
public record ServerStateCmd(Core core) implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String @NotNull [] args) {
        ...
        if (!player.hasPermission("ninjasmp.event.cmd.serverstate")) {
            ...
            player.sendMessage(MessageBuilder.buildOld("§8| §x§4§4§9§8§D§BS§x§3§C§9§2§E§0M§x§3§5§8§C§E§4P§x§2§D§8§6§E§9-§x§2§5§8§0§E§DE§x§1§D§7§A§F§2v§x§1§6§7§4§F§6e§x§0§E§6§E§F§Bn§x§0§6§6§8§F§Ft §8» §r%r✘ §8| §7Benutze %b/switch-event-server-state {boolean}"));
            return true;
        }
        ...
        if (args[0].equalsIgnoreCase("true")) {
            ...
            player.sendMessage(MessageBuilder.buildOld("§8| §x§4§4§9§8§D§BS§x§3§C§9§2§E§0M§x§3§5§8§C§E§4P§x§2§D§8§6§E§9-§x§2§5§8§0§E§DE§x§1§D§7§A§F§2v§x§1§6§7§4§F§6e§x§0§E§6§E§F§Bn§x§0§6§6§8§F§Ft §8» §r%r✘ §8| §7Der §x§4§4§9§8§D§BEvent-Server §7ist jetzt %rdeaktiviert§7!"));
